			...
			<li>
                ...
                <li>
                    <a href="dashboard.html">
                        ...
                        <p>Recieved Payment(s)</p>
                    </a>
                </li>
                <li>
                    <a href="dashboard.html">
                        <i class="pe-7s-graph"></i>
                        <p>Outgoing Payment(s)</p>
                    </a>
                </li>
                <li>
                    <a href="table.html">
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script> Developed by <a href="http://www.klearapps.co.za">Klear Apps</a>
                </p>
            </div>
        </footer>
